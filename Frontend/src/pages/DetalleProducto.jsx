...
function DetalleProducto() {
  ...
  useEffect(() => {
    axios.get(`https://elo-joyeria-backend.vercel.app/api/productos/${id}`)
      .then(response => {
  ...
  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '60px 20px' }} className="detalle-producto-container">
      ...
      <div style={{ display: 'flex', gap: '50px', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: '1 1 450px', minWidth: '300px' }}>
          ...
          <button 
            ...
            style={{
              width: '100%', background: '#b59410', color: '#fff', border: 'none', padding: '16px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '15px', marginBottom: '35px', padding: '10px', backgroundColor: '#f9f9f9', borderRadius: '4px', border: '1px dashed #ddd' }}>
            <span style={{ fontSize: '0.8rem', color: '#666', fontWeight: '500', letterSpacing: '0.5px' }}>💳 Aceptamos Sinpe Móvil</span>
          </div>
          ...
          <div>
            ...
            {infoAbierta && <div style={estiloCuerpoAcordeon}><p style={{ margin: 0, lineHeight: '1.6', color: '#555' }}>{producto.descripcion}</p></div>}
            ...
            {envioAbierto && <div style={estiloCuerpoAcordeon}><p style={{ margin: 0, lineHeight: '1.6', color: '#555' }}>Hacemos envíos rápidos y seguros a todo el país.</p></div>}
          </div>
        </div>
      </div>
