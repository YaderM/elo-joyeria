    ...
    <div style={{ width: '100%', boxSizing: 'border-box' }}>
      ...
      <div className="grid-promociones">
        ...
        <div>
          ...
          <div style={{ width: '100%', overflowX: 'auto', WebkitOverflowScrolling: 'touch', maxHeight: '400px', border: '1px solid #eee', borderRadius: '6px' }}>
            <table style={{ width: '100%', minWidth: '450px', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
              <thead>
        ...
        <div style={{ backgroundColor: '#fdfdfd', border: '1px solid #e9e9e9', padding: '25px', borderRadius: '8px', boxSizing: 'border-box' }}>
...
const estiloSelectForm = { width: '100%', padding: '10px', border: '1px solid #ccc', borderRadius: '6px', fontSize: '0.9rem', outline: 'none', backgroundColor: '#fff', boxSizing: 'border-box' };
const estiloBotonOroGrande = { width: '100%', backgroundColor: '#b59410', color: '#fff', border: 'none', padding: '12px', borderRadius: '6px', fontWeight: '600', cursor: 'pointer', fontSize: '0.9rem', boxSizing: 'border-box' };
